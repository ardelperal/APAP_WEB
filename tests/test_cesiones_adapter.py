...
# ---------------------------------------------------------------------------
# LocalBackend adapter
# ---------------------------------------------------------------------------


class TestCesionesLocalBackendAdapter:
    def test_adapter_implements_port_protocol(self) -> None:
        """CesionesLocalBackendAdapter satisfies CesionesPort at runtime."""
        adapter = CesionesLocalBackendAdapter(object())
...
class TestCesionesPortRuntimeCheckable:
    ...
    def test_missing_methods_fails_protocol_check(self) -> None:
        ...
        assert isinstance(CesionesLocalBackendAdapter(object()), CesionesPort)
