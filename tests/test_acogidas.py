...
patterns: ``_FakeSqlExecutor`` for SQL shape assertion (issue #732 Arc B).
Each test records the SQL queries captured and asserts the shape;
the assertions fail loudly if a future refactor breaks the contract.
"""
