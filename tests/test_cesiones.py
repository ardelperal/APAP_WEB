...
``_FakeSqlExecutor`` so every SQL the service emits is captured and
asserted, no live backend. Covers issue #41 (INTAKE-03) end to end at
the service layer (issue #732 Arc B):
