...
# guards (judgment-day CRITICAL ┬º1.2 + HIGH ┬º3.2 follow-up to PR
...
def create_acogida(
    ...
    ``override_id`` forgery ÔÇö judgment-day CRITICAL ┬º1.2 + HIGH
    ┬º3.2 follow-up to PR #155). In any of those "no link" cases we
    ...
    if isinstance(override_id_raw, str) and override_id_raw.strip():
        # Defense (judgment-day CRITICAL ┬º1.2 / HIGH ┬º3.2 follow-up):
