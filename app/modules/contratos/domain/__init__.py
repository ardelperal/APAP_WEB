...
- :class:`Plantilla` and :class:`PlantillaInvalida` (template body +
  grammar validation).
...
from app.modules.contratos.domain.plantilla import Plantilla, PlantillaInvalida, validar_gramatica
