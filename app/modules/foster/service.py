...
_INSERT_CASA_SQL: Final[str] = (
    f"INSERT INTO casas_acogida ({', '.join(_WRITE_COLUMNS)}) "  # noqa: S608 constant identifiers
...
_GET_CASA_BY_ID_SQL: Final[str] = (
    f"SELECT {', '.join(_SELECT_COLUMNS)} FROM casas_acogida WHERE id = $1"  # noqa: S608
)


_UPDATE_CASA_SQL: Final[str] = (
    "UPDATE casas_acogida SET "  # noqa: S608 constant identifiers; values are $N binds
