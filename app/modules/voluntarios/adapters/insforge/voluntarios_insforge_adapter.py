"""InsForge adapter implementing :class:`app.modules.voluntarios.ports.voluntarios_port.VoluntariosPort`.

Slice: app/modules/voluntarios (epic #420 PR-A + VOL-02).
All InsForge / PostgreSQL access is isolated here.  The port contract is
...
from app.modules.voluntarios.adapters.insforge.voluntarios_insforge_mappers import (
    row_to_voluntario,
)
from app.modules.voluntarios.adapters.insforge.voluntarios_insforge_queries import (
    GET_VOLUNTARIO_BY_ID_SQL,
    LIST_VOLUNTARIO_ROLES_SQL,
    LIST_VOLUNTARIOS_SQL,
)
from app.modules.voluntarios.adapters.insforge.voluntarios_insforge_write_queries import (
    ASSIGN_ROLE_SQL,
...
class VoluntariosInsForgeAdapter:
    """InsForge-backed implementation of :class:`VoluntariosPort`."""
...
__all__ = ["VoluntariosInsForgeAdapter"]
