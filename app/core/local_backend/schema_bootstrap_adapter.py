"""LocalBackend adapter implementing :class:`SchemaBootstrapPort`.
...
class LocalBackendSchemaBootstrapAdapter:
    """LocalBackend implementation of :class:`SchemaBootstrapPort`.
...
__all__ = ["LocalBackendSchemaBootstrapAdapter"]
