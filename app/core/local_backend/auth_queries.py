"""SQL constants for the LocalBackend ``usuarios_autorizados`` adapter.
...
``tests/test_admin.py::_FakeLocalBackend.execute_sql`` (keys on
...
# ``tests/test_admin.py::_FakeLocalBackend.execute_sql`` to route the
