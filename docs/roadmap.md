...
| #218 | `execute_legacy_write`: `conn.commit()` failure swallowed (silent durability gap) | Migración | ✅ cerrada 2026-07-27 (PR #TBD, fix/issue-218-commit-durability) — ver §"Cerradas hoy (2026-07-27)" abajo |
