...
| [`app/modules/animals/`](../../app/modules/animals/) | Slice de negocio (animals) con conversión hexagonal parcial in-place (`domain/`, `ports/`, `application/<use_case>.py`, `adapters/insforge/`) — PRs #587, #596, #597, #603, #604, #609, #610, #611. Sirve de ejemplo vivo de la ruta §33.2 para módulos con razón de negocio propia. |
