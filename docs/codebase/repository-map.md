...
| [`app/modules/animals/`](../../app/modules/animals/) | Slice con los nueve métodos de `AnimalsPort` aterrizados. Las rutas aún usan los servicios legacy; la conversión no está completa. |
