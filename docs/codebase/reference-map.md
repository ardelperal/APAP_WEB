...
- **Single source of truth por concepto**: una regla vive en `AGENTS.md`, un contrato de stack en [Arquitectura InsForge](../architecture-insforge-stack.md), un playbook operativo en [proceso.md](../proceso.md); las radiales referencian, no duplican.
...
| [Integrations](integrations.md) | InsForge, CodeGraph, Dysflow, Coolify, GitHub | — | Nuevo en #553 |
...
| [Arquitectura InsForge](../architecture-insforge-stack.md) | Contrato de stack y target de despliegue | — | Vive, contract de infra |
