...
- **P1 fidelidad al legacy**: cada capacidad del Access se conserva o se reemplaza por un equivalente documentado en [decisiones-proyecto](../decisiones-proyecto.md). Una brecha descubierta se abre como `type:bug gap:legacy`.
...
- [ ] Antes de declarar una divergencia con el legacy, regístrela en [decisiones-proyecto](../decisiones-proyecto.md) en la misma sesión.
