...
Configure `main` so every pull request is gated by the CI workflow before merge.
...
Before merging the CI workflow PR, attach one of these to the PR comment:

- A screenshot of the `main` branch protection rule showing the three required checks.
