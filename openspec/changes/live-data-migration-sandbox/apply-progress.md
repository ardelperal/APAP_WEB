...
- Mutation status: PR4b + 4R performed ZERO InsForge / Access / psutil mutation. All 71 atoms run under `httpx.MockTransport` or against injected `FakeInsForge` / `_StorageLike` Protocol fakes.
