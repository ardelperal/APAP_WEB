...
BASELINE: dict[tuple[str, ...], str] = {
    ...
    ("app.modules.sanidad", "app.modules.sanidad.service"):
        "service.py imports queries via the package root (line 56); __init__ re-exports service -- tolerated mid-migration (Refs #420)",
