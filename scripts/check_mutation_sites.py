...
BASELINE_MUTATION_SITES: dict[str, int] = {
    ...
    "app/modules/materiales/adapters/local_backend/materiales_local_backend_adapter.py": 284,  # issue #752 PR 5: lifted _row_to_*, _is_unique_violation, _validate_* from the legacy service.py into the adapter; baseline tracks the new size.
